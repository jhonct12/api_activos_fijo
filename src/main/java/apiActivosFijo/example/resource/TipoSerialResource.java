...
public class TipoSerialResource {
    ...
    public Response getTipoSerialByCode(@QueryParam(CODIGO) String codigo){
        ...
        TipoSerial tipoSerial = tipoSerialService.getTipoSerialByCode(codigo);
    ...
    @POST
    public Response createTipoSerial(TipoSerial tipoSerial){
        if (tipoSerial.getCodigo().equals("")){
            return responses.getResponse(Response.Status.BAD_REQUEST, KEY_TIPO_SERIAl, new String[]{CODIGO, DESCRIPCION}, new String[]{"", "El codigo ingresado no puede estar vacio"});
        }

        TipoSerial buscarTipoSerial = tipoSerialService.getTipoSerialByCode(tipoSerial.getCodigo());
        ...
        TipoSerial createTipoSerial = tipoSerialService.createTipoSerial(tipoSerial);
        return Response.status(Response.Status.CREATED).entity(createTipoSerial).build();
    }

    @PUT
    public Response updateTipoSerial(TipoSerial tipoSerial){
        if (tipoSerial.getCodigo().equals("")){
            return responses.getResponse(Response.Status.BAD_REQUEST, KEY_TIPO_SERIAl, new String[]{CODIGO, DESCRIPCION}, new String[]{"", "El codigo ingresado no puede estar vacio"});
        }
        ...
        TipoSerial tipoSerialToUpdate = tipoSerialService.updateTipoSerial(tipoSerial.getCodigo(), tipoSerial);
    ...
    public Response deleteTipoSerial(@QueryParam(CODIGO) String codigo){
        ...
        TipoSerial tipoSerial = tipoSerialService.deleteTipoSerial(codigo);
        return Response.ok(tipoSerial).build();
    }
